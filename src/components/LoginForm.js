        ...
        <StyleLoginForm>
            <div id="loginform">
                ...
                <form onSubmit={onSubmitHandler}>
                    <div class="row">
                        <label>Email</label>
                        <input type="email" value={email} onChange={handleInput("email")} placeholder="Enter your Email" />
                    </div>
                    <div class="row">
                        <label>Password</label>
                        <input type="password" value={password} onChange={handleInput("password")} placeholder="Enter your password"/>
                    </div>
